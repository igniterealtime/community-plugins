...
public class SipComponent implements Component, SessionEventListener {
    ...
    public void shutdown() {
        ...
        Log.info("SipComponent shutdown");

		try {
			Collection<SipAccount> accounts = SipAccountDAO.getUsers(0, 4096);

			for (SipAccount sipAccount : accounts)
			{
				Log.info("unregistering " + sipAccount.getUsername());
    ...
    public void sessionDestroyed(Session session) {
        ...
        String username = JID.escapeNode(session.getAddress().getNode());
