...
public class OfMeetLoginService extends AbstractLoginService
{
    ...
    public static final Map<String, AuthToken> authTokens = new HashMap<String, AuthToken>();
    ...
    public UserIdentity login( String userName, Object credentials )
    {
        ...
        try
        {
            ...
            final Principal principal = new KnownUser( authToken.getUsername(), userName);
            ...
            Log.info( "Login succeeded for local user " + username );
        ...
        catch ( UnauthorizedException ex )
        {
            ...
            Log.info( "Login failed for " + username, ex );
            return null;
        }
        catch ( Exception ex )
        {
            // System failure! Configuration should be checked server-sided.
            Log.error( "An internal problem caused authentication to fail for "+ username, ex );
            return null;
        }
    }
