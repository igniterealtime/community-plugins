...
/**
 * A login service for event source (server-sent) events that uses Openfire to authenticate users
 *
 */

public class EventSourceLoginService extends AbstractLifeCycle implements LoginService
{
    private static final Logger Log = LoggerFactory.getLogger(EventSourceLoginService.class);
    ...
    protected EventSourceLoginService()
    {

    }

    public EventSourceLoginService(String name)
    {
        setName(name);
    }
