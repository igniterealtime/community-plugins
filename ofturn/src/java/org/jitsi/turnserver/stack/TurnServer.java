...
{
    private static final Logger Log = LoggerFactory.getLogger(TurnServer.class);
    ...
    public void start() throws IOException, TurnException
    {
        ...
        Log.debug("Local address - " + localAddress.getHostAddress() + ":" + localAddress.getPort());
        ...
        Log.debug("Adding a TCP server socket - "
        ...
        Log.debug("Adding a UDP server socket - "
        ...
        started = true;
        Log.info("Server started, listening on " + localAddress.getAddress() + ":" + localAddress.getPort());
    ...
    {
        Log.info("Stopping server at " + localAddress.getAddress() + ":"
