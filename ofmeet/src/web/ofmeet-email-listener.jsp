...
<%@ page import="org.jivesoftware.openfire.plugin.ofmeet.EmailListener,
    ...
    if (test && errors.isEmpty()) {
        ...
        if (save) {
            if (errors.isEmpty()) {
                ...
                response.sendRedirect("ofmeet-email-listener.jsp?success=true");
            }
        }
...
<html>
    <head>
        ...
        <meta name="pageID" content="ofmeet-email-listener"/>
    </head>
    <body>
...
<!-- BEGIN SMTP settings -->
<form action="ofmeet-email-listener.jsp" name="f" method="post">
