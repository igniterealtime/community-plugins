...
(function() {
  ...
  this.Woot.QuillAdapter = (function() {
    ...
    QuillAdapter.prototype.textChange = function(delta, source) {
      var di, i, index, j, l, last_retain, length, op, _i, _j, _k, _l, _len, _ref, _ref1, _ref2, _ref3, _ref4, _results;
      if (source !== 'user') {
        return;
      }
      index = 0;
      ...
      l = 0;
      _ref = delta.ops;
      for (di = _i = 0, _len = _ref.length; _i < _len; di = ++_i) {
        op = _ref[di];
        if (op.start || op.end) {
          ...
          if ($.isEmptyObject(op.attributes)) {
            ...
            for (j = _j = _ref1 = op.start, _ref2 = op.end - 1; _j <= _ref2; j = _j += 1) {
          ...
          for (i = _k = 0, _ref3 = length - 1; _k <= _ref3; i = _k += 1) {
      ...
      _results = [];
      for (i = _l = last_retain, _ref4 = delta.startLength - 1; _l <= _ref4; i = _l += 1) {
