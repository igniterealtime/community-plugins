...
(function() {
  ...
  Woot.Site = (function() {
    ...
    Site.prototype.insert = function(c, p) {
      var i, _i, _ref;
      for (i = _i = _ref = this.string.length - 1; _ref <= p ? _i <= p : _i >= p; i = _ref <= p ? ++_i : --_i) {
    ...
    Site.prototype.subseq = function(c, d) {
      var end, i, start, sub, _i, _ref, _ref1;
      sub = [];
      start = this.pos(c);
      end = this.pos(d);
      if (start + 1 <= end - 1 && start > -1 && end > -1) {
        for (i = _i = _ref = start + 1, _ref1 = end - 1; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = _ref <= _ref1 ? ++_i : --_i) {
